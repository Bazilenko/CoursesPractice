...
namespace CoursesWeb.Services
{
    public class TeacherService : ITeacherService
    {
        ...
        public Task<AssignmentFullResponseDTO> CreateAsync(CreateAssignmentReqDTO dto, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<IEnumerable<TeacherMiniResponseDTO>> GetAllAsync()
        {
            ...
            return _mapper.Map<IEnumerable<TeacherMiniResponseDTO>>(teachers);
        }
